...
# input: ary
# output: sorted ary using bubble sort method per above
# assume: ary contains at least two elem
# logic: iterate thru ary, if first > second then swap and add 1 to swap count.
#       increment first & second and compare again. Do this until second == ary.size - 1
